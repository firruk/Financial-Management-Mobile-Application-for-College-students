...
class _SavingsaddState extends State<Savingsadd> {
  ...
  Widget build(BuildContext context) {
    ...
    final TextEditingController Savingsannual=TextEditingController(text: savingsannnualamt.toStringAsFixed(3));
    final TextEditingController Savingsmonthly=TextEditingController(text: savings.toStringAsFixed(3));
