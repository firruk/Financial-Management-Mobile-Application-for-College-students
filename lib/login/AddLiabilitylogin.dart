import 'package:budget/login/Budgetadd.dart';

import 'package:budget/services/database_add1.dart';
import 'package:flutter/material.dart';
import 'package:fluttertoast/fluttertoast.dart';

class addLiabilitieslogin extends StatefulWidget {
  const addLiabilitieslogin({Key? key}) : super(key: key);

  @override
  _addLiabilitiesloginState createState() => _addLiabilitiesloginState();
}

class _addLiabilitiesloginState extends State<addLiabilitieslogin> {
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: RaisedButton(
                              onPressed:(){
                                Navigator.push(context,MaterialPageRoute(builder:(contect)=>Budgetadd()));
                              },
                              color:Colors.deepPurple,
                              textColor:Colors.white ,
                              shape: RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(10.0))),
